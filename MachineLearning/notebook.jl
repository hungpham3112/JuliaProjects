...
# ╔═╡ f664a7c0-c122-489e-b9ae-a05994c1da61
df_selected = df[:, ["price", "area"]]

# ╔═╡ adde84ef-402a-4e14-bb82-fd1dbfa93583
# drop missing value (NAN, null...)
df_dropna = dropmissing(df_selected)

# ╔═╡ 918dbdae-b9e3-475c-840e-9a03c6315a4e
begin
	price = df_dropna[:, "price"]
	area = df_dropna[:, "area"]
end
