...
using LinearAlgebra, HDF5, Images , Plots , ImageShow, ImageView
...
train_set_x = read(train_data["train_set_x"])

# ╔═╡ 7a3cbc89-cc29-40f5-8809-26a8195a26ca
begin
	image = (train_set_x[:, :, :, 1])
	Images.colorview(RGB, image)
end

# ╔═╡ fbb0fd2f-acdc-4b10-844a-cbe8bcd2a4a4
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "c79fe98b97cef7cffc9b82012ce8e203d4a77a32"
...
# ╠═7a3cbc89-cc29-40f5-8809-26a8195a26ca
# ╠═fbb0fd2f-acdc-4b10-844a-cbe8bcd2a4a4
# ╠═c18e2c24-5adc-4663-9d98-1dec97a0528c
# ╠═87919742-52b5-42eb-a3d2-fd5073674b65
# ╠═ac9c2ca4-ab48-4911-8354-3d29b4a7cabd
# ╟─00000000-0000-0000-0000-000000000001
# ╟─00000000-0000-0000-0000-000000000002
